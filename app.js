...
var createNewTaskElement = function (taskString) {
    ...
    label.classList.add('label', 'task-name');

    var editInput = document.createElement('input');
    editInput.type = "text";
    editInput.classList.add('input-text', 'tasks__input', 'task-name');
...
var editTask = function () {
    ...
    if (containsClass) {
        ...
        editInput.classList.remove('tasks__input_edit-mode');
        ...
        editInput.classList.remove('tasks__input');
        editInput.classList.add('tasks__input_edit-mode');
...
var taskCompleted = function () {
    ...
    var listItem = this.parentNode;
    var label = listItem.querySelector('.label');
    label.classList.add('label_task_completed');
...
//Mark task as incomplete.
    ...
    var listItem = this.parentNode;
    var label = listItem.querySelector('.label');
    label.classList.remove('label_task_completed');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem, taskCompleted);
}
